...
import Semantic.Resolve.Temporary.Complete.TypeDeclaration (TypeDeclaration (TypeDeclaration))
import qualified Semantic.Resolve.Temporary.Complete.TypeDeclaration as TypeDeclaration
