...
import Semantic.Resolve.Temporary.Complete.Method (Method (Method))
import qualified Semantic.Resolve.Temporary.Complete.Method as Method
import Semantic.Resolve.Temporary.Complete.Selector (Selector (Selector))
import qualified Semantic.Resolve.Temporary.Complete.Selector as Selector
...
import qualified Semantic.Resolve.Temporary.Partial.TypeDeclaration as Partial
