...
data TypeDeclaration locality scope
  = Annotated
      { position :: !Position,
        ...
        definition :: !(TypeDefinition2 locality Annotated Normal scope)
      }
  | Inferred
      { position :: !Position,
        name :: !ConstructorIdentifier,
        constructorNames :: !(Strict.Vector Constructor),
        definition' :: !(TypeDefinition2 locality Inferred Normal scope),
...
group ::
  ...
  Proper.TypeDeclaration locality Normal scope ->
...
proper :: TypeDeclaration locality scope -> Proper.TypeDeclaration locality Normal scope
proper = \case
  Annotated {position, name, constructorNames, annotation, definition} ->
