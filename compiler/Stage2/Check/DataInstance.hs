module Stage2.Check.DataInstance where
...
import Stage2.Check.ConstructorInstance (ConstructorInstance (..))
import qualified Stage2.Check.ConstructorInstance as Constructor (info)
import qualified Stage2.Check.ConstructorInstance as ConstructorInstance
import Stage2.Check.Context (Context)
import Stage2.Check.EntryInstance (EntryInstance (..))
import Stage2.Check.Temporary.SelectorInfo (Select (..), SelectorInfo (..))
