module Stage2.Check.Temporary.Entry where
...
import Stage2.Check.Temporary.StrictnessAnnotation (StrictnessAnnotation)
import qualified Stage2.Check.Temporary.StrictnessAnnotation as StrictnessAnnotation
