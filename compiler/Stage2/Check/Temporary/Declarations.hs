module Stage2.Check.Temporary.Declarations (Declarations (..), check, solve) where
...
import Stage2.Check.Context (Context (..), localBindings)
import qualified Stage2.Check.Functor.Annotated as Functor (Annotated (..), content)
import Stage2.Check.Functor.Declarations (mapWithKey)
import qualified Stage2.Check.Functor.Declarations as Functor (Declarations (..), fromStage2)
...
import Stage2.Check.Temporary.Declaration (Declaration (..))
import qualified Stage2.Check.Temporary.Declaration as Declaration
import qualified Stage2.Check.Temporary.Definition4 as Definition4
import Stage2.Check.Temporary.Instance (Instance)
import qualified Stage2.Check.Temporary.Instance as Instance
import Stage2.Check.Temporary.TypeDeclarationExtra (TypeDeclarationExtra)
import qualified Stage2.Check.Temporary.TypeDeclarationExtra as TypeDeclarationExtra
import qualified Stage2.Check.Go.Declarations as Solved
