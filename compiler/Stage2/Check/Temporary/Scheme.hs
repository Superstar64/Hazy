...
import Stage2.Check.LocalBinding (LocalBinding (Wobbly, label, wobbly))
...
import {-# SOURCE #-} qualified Stage2.Check.Temporary.Type as Type (check, solve)
import Stage2.Check.Temporary.TypePattern (TypePattern (TypePattern))
