module Stage2.Check.Functor.Module where
...
import Stage2.Check.Functor.Declarations (Declarations)
import qualified Stage2.Check.Functor.Declarations as Declarations
import Stage2.Check.Functor.Instance.Key (Key)
