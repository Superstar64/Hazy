module Stage2.Check.Simple.SchemeOver
  ( Lift (..),
    lift,
    augmentNamed,
    augment,
...
import qualified Stage2.Check.Simple.Constraint as Constraint (lift)
import qualified Stage2.Check.Simple.Type as Type (lift)
import qualified Stage2.Check.TypeBinding as TypeBinding
import qualified Stage2.Index.Evidence as Evidence (assumed)
