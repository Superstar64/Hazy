module Stage2.Check.Go.TypeDeclaration (TypeDeclaration (..), kind', check, lazy) where
...
import Stage2.Check.Context (Context (..), groupTypeBindings)
import qualified Stage2.Check.KindAnnotation as KindAnnotation
import qualified Stage2.Check.KindAnnotation as Stage3
import qualified Stage2.Check.Simple.Type as Simple.Type
import qualified Stage2.Check.Temporary.TypeDefinition as Temporary.TypeDefinition
import qualified Stage2.Check.Temporary.TypeDefinition as TypeDefinition
import qualified Stage2.Check.Temporary.TypeDefinition2 as Temporary
