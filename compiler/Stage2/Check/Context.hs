...
import Stage2.Check.LocalBinding (LocalBinding)
import qualified Stage2.Check.LocalBinding as LocalBinding
import Stage2.Check.TermBinding (TermBinding)
import qualified Stage2.Check.TermBinding as TermBinding
import {-# SOURCE #-} Stage2.Check.TypeAnnotation (TypeAnnotation)
import Stage2.Check.TypeBinding (TypeBinding (..))
import qualified Stage2.Check.TypeBinding as TypeBinding
import {-# SOURCE #-} qualified Stage2.Check.Temporary.Declaration as Temporary (Declaration)
import {-# SOURCE #-} qualified Stage2.Check.Temporary.TypeDeclarationExtra as Temporary (TypeDeclarationExtra)
