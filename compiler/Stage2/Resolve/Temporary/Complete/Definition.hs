module Stage2.Resolve.Temporary.Complete.Definition where
...
import qualified Stage2.Resolve.Go.Function as Function (resolve)
import qualified Stage2.Resolve.Go.Pattern as Pattern (augment)
import Stage2.Stage (Resolve)
import qualified Stage2.Resolve.Temporary.PatternInfix as Pattern.Infix (fixWith, resolve)
