module Stage2.Resolve.Temporary.Complete.TypeDeclaration where
...
import Stage2.Resolve.Temporary.Complete.GADTConstructor (GADTConstructor (GADTConstructor))
import qualified Stage2.Resolve.Temporary.Complete.GADTConstructor as GADTConstructor
import Stage2.Resolve.Temporary.Complete.Method (Method (Method))
import qualified Stage2.Resolve.Temporary.Complete.Method as Method
import Stage2.Resolve.Temporary.Complete.Selector (Selector (Selector))
import qualified Stage2.Resolve.Temporary.Complete.Selector as Selector
...
import qualified Stage2.Resolve.Temporary.Partial.TypeDeclaration as Partial
