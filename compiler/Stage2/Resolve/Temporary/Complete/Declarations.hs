module Stage2.Resolve.Temporary.Complete.Declarations where
...
import qualified Stage2.Resolve.Temporary.Complete.ClassInstance as ClassInstance
import Stage2.Resolve.Temporary.Complete.ConstructorDeclaration (ConstructorDeclaration)
import qualified Stage2.Resolve.Temporary.Complete.ConstructorDeclaration as Constructor (merge)
import qualified Stage2.Resolve.Temporary.Complete.ConstructorDeclaration as ConstructorDeclaration
import qualified Stage2.Resolve.Temporary.Complete.DataInstance as DataInstance
import Stage2.Resolve.Temporary.Complete.Declaration (Declaration (Declaration), name)
import qualified Stage2.Resolve.Temporary.Complete.Declaration as Term (bindings, indexes, merge, shrink)
import Stage2.Resolve.Temporary.Complete.TypeDeclaration (TypeDeclaration)
import qualified Stage2.Resolve.Temporary.Complete.TypeDeclaration as Type (bindings, indexes, merge, shrink, shrinkExtra)
import qualified Stage2.Resolve.Temporary.Partial.ConstructorDeclaration as Constructor (resolve)
import Stage2.Resolve.Temporary.Partial.Declaration (Key (Unnamed))
import qualified Stage2.Resolve.Temporary.Partial.Declaration as Term (resolve)
import qualified Stage2.Resolve.Temporary.Partial.TypeDeclaration as Declaration.Type (resolve)
