...
module Stage2.Resolve.Temporary.Complete.ConstructorDeclaration where
...
import qualified Stage2.Resolve.Temporary.Partial.ConstructorDeclaration as Source
