module Stage2.Resolve.Temporary.Complete.Declaration where
...
import Stage2.Resolve.Temporary.Partial.Declaration (Key (..))
import qualified Stage2.Resolve.Temporary.Partial.Declaration as Partial
