module Stage2.Resolve.Temporary.Complete.ClassInstance where
...
import Stage2.Resolve.Temporary.Complete.TypeDeclaration (TypeDeclaration (TypeDeclaration))
import qualified Stage2.Resolve.Temporary.Complete.TypeDeclaration as TypeDeclaration
