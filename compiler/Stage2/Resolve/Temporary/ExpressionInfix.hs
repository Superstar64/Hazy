module Stage2.Resolve.Temporary.ExpressionInfix where
...
import Stage2.Resolve.Temporary.Infix (Infix (..))
import qualified Stage2.Resolve.Temporary.Infix as Infix
