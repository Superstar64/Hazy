...
module Stage2.Resolve.Temporary.Partial.ConstructorDeclaration where
...
import qualified Stage2.Resolve.Temporary.Complete.Constructor as Complete (Constructor (Constructor))
import qualified Stage2.Resolve.Temporary.Complete.Constructor as Complete.Constructor
import Stage2.Resolve.Temporary.Complete.Field (Field (Field))
import qualified Stage2.Resolve.Temporary.Complete.Field as Field
import qualified Stage2.Resolve.Temporary.Complete.GADTConstructor as Complete (GADTConstructor (GADTConstructor))
import qualified Stage2.Resolve.Temporary.Complete.GADTConstructor as Complete.GADTConstructor
import qualified Stage2.Resolve.Temporary.Complete.TypeDeclaration as Complete
  ( Constructors (..),
    TypeDeclaration
      ( TypeDeclaration,
        constructors
...
import qualified Stage2.Resolve.Temporary.Partial.More.Constructor as More
