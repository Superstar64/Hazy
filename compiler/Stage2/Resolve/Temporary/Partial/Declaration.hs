...
module Stage2.Resolve.Temporary.Partial.Declaration
  ( Declaration (..),
    Key (..),
    resolve,
  )
...
import {-# SOURCE #-} qualified Stage2.Resolve.Temporary.Complete.Declaration as Complete
...
import qualified Stage2.Resolve.Temporary.Complete.Method as Complete (Method (Method))
import qualified Stage2.Resolve.Temporary.Complete.Method as Complete.Method
...
import qualified Stage2.Resolve.Temporary.Complete.TypeDeclaration as Complete (TypeDeclaration (TypeDeclaration))
import qualified Stage2.Resolve.Temporary.Complete.TypeDeclaration as Complete.TypeDeclaration
import qualified Stage2.Resolve.Temporary.Partial.More.Choice as More (Choice (Choice))
import qualified Stage2.Resolve.Temporary.Partial.More.Choice as More.Choice
import qualified Stage2.Resolve.Temporary.Partial.More.Function as More (Function (Function))
import qualified Stage2.Resolve.Temporary.Partial.More.Function as More.Function
import qualified Stage2.Resolve.Temporary.Partial.More.Method as More (Method (Method))
import qualified Stage2.Resolve.Temporary.Partial.More.Method as More.Method
import qualified Stage2.Resolve.Temporary.Partial.More.Selector as More (Selector (Selector))
import qualified Stage2.Resolve.Temporary.Partial.More.Selector as More.Selector
